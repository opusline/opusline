...
export const listDeclarations = <ThrowOnError extends boolean = false>(options?: Options<ListDeclarationsData, ThrowOnError>): RequestResult<ListDeclarationsResponses, ListDeclarationsErrors, ThrowOnError> => (options?.client ?? client).get<ListDeclarationsResponses, ListDeclarationsErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'opusline-session',
            type: 'apiKey'
 ...
 */
export const recordDeclaration = <ThrowOnError extends boolean = false>(options: Options<RecordDeclarationData2, ThrowOnError>): RequestResult<RecordDeclarationResponses, RecordDeclarationErrors, ThrowOnError> => (options.client ?? client).post<RecordDeclarationResponses, RecordDeclarationErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'opusline-session',
            type: 'apiKey'
...
export const listFiscalDeadlines = <ThrowOnError extends boolean = false>(options?: Options<ListFiscalDeadlinesData, ThrowOnError>): RequestResult<ListFiscalDeadlinesResponses, ListFiscalDeadlinesErrors, ThrowOnError> => (options?.client ?? client).get<ListFiscalDeadlinesResponses, ListFiscalDeadlinesErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'opusline-session',
            type: 'apiKey'
