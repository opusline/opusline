 ...
 */
export const recordTreasuryTransfer = <ThrowOnError extends boolean = false>(options: Options<RecordTreasuryTransferData2, ThrowOnError>): RequestResult<RecordTreasuryTransferResponses, RecordTreasuryTransferErrors, ThrowOnError> => (options.client ?? client).post<RecordTreasuryTransferResponses, RecordTreasuryTransferErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'opusline-session',
            type: 'apiKey'
