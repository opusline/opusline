 ...
 */
export const lockSessionMutation = (options?: Partial<Options<LockSessionData>>): UseMutationOptions<LockSessionResponse, LockSessionError, Options<LockSessionData>> => {
    const mutationOptions: UseMutationOptions<LockSessionResponse, LockSessionError, Options<LockSessionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await lockSession({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const updateUserPasswordMutation = (options?: Partial<Options<UpdateUserPasswordData2>>): UseMutationOptions<UpdateUserPasswordResponse, UpdateUserPasswordError, Options<UpdateUserPasswordData2>> => {
    const mutationOptions: UseMutationOptions<UpdateUserPasswordResponse, UpdateUserPasswordError, Options<UpdateUserPasswordData2>> = {
        mutationFn: async (fnOptions) => {
...
export const listBankAspspsQueryKey = (options?: Options<ListBankAspspsData>) => createQueryKey('listBankAspsps', options);

export const listBankAspspsOptions = (options?: Options<ListBankAspspsData>) => queryOptions<ListBankAspspsResponse, ListBankAspspsError, ListBankAspspsResponse, ReturnType<typeof listBankAspspsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listBankAspsps({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listBankAspspsQueryKey(options)
});

export const disconnectBankConnectionMutation = (options?: Partial<Options<DisconnectBankConnectionData>>): UseMutationOptions<DisconnectBankConnectionResponse, DisconnectBankConnectionError, Options<DisconnectBankConnectionData>> => {
    const mutationOptions: UseMutationOptions<DisconnectBankConnectionResponse, DisconnectBankConnectionError, Options<DisconnectBankConnectionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await disconnectBankConnection({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const startBankConnectionMutation = (options?: Partial<Options<StartBankConnectionData2>>): UseMutationOptions<StartBankConnectionResponse, StartBankConnectionError, Options<StartBankConnectionData2>> => {
    const mutationOptions: UseMutationOptions<StartBankConnectionResponse, StartBankConnectionError, Options<StartBankConnectionData2>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await startBankConnection({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const completeBankConnectionMutation = (options?: Partial<Options<CompleteBankConnectionData2>>): UseMutationOptions<CompleteBankConnectionResponse, CompleteBankConnectionError, Options<CompleteBankConnectionData2>> => {
    const mutationOptions: UseMutationOptions<CompleteBankConnectionResponse, CompleteBankConnectionError, Options<CompleteBankConnectionData2>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await completeBankConnection({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const chooseBankConnectionAccountMutation = (options?: Partial<Options<ChooseBankConnectionAccountData>>): UseMutationOptions<ChooseBankConnectionAccountResponse, ChooseBankConnectionAccountError, Options<ChooseBankConnectionAccountData>> => {
    const mutationOptions: UseMutationOptions<ChooseBankConnectionAccountResponse, ChooseBankConnectionAccountError, Options<ChooseBankConnectionAccountData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await chooseBankConnectionAccount({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const syncBankConnectionMutation = (options?: Partial<Options<SyncBankConnectionData>>): UseMutationOptions<SyncBankConnectionResponse, SyncBankConnectionError, Options<SyncBankConnectionData>> => {
    const mutationOptions: UseMutationOptions<SyncBankConnectionResponse, SyncBankConnectionError, Options<SyncBankConnectionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await syncBankConnection({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const showInstanceOptions = (options?: Options<ShowInstanceData>) => queryOptions<ShowInstanceResponse, ShowInstanceError, ShowInstanceResponse, ReturnType<typeof showInstanceQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await showInstance({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: showInstanceQueryKey(options)
});

export const showIntegrationsQueryKey = (options?: Options<ShowIntegrationsData>) => createQueryKey('showIntegrations', options);

export const showIntegrationsOptions = (options?: Options<ShowIntegrationsData>) => queryOptions<ShowIntegrationsResponse, ShowIntegrationsError, ShowIntegrationsResponse, ReturnType<typeof showIntegrationsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await showIntegrations({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: showIntegrationsQueryKey(options)
});

export const deleteEnableBankingCredentialsMutation = (options?: Partial<Options<DeleteEnableBankingCredentialsData>>): UseMutationOptions<DeleteEnableBankingCredentialsResponse, DeleteEnableBankingCredentialsError, Options<DeleteEnableBankingCredentialsData>> => {
    const mutationOptions: UseMutationOptions<DeleteEnableBankingCredentialsResponse, DeleteEnableBankingCredentialsError, Options<DeleteEnableBankingCredentialsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteEnableBankingCredentials({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const saveEnableBankingCredentialsMutation = (options?: Partial<Options<SaveEnableBankingCredentialsData2>>): UseMutationOptions<SaveEnableBankingCredentialsResponse, SaveEnableBankingCredentialsError, Options<SaveEnableBankingCredentialsData2>> => {
    const mutationOptions: UseMutationOptions<SaveEnableBankingCredentialsResponse, SaveEnableBankingCredentialsError, Options<SaveEnableBankingCredentialsData2>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await saveEnableBankingCredentials({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
