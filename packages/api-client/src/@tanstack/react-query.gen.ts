 ...
 */
export const recordTreasuryTransferMutation = (options?: Partial<Options<RecordTreasuryTransferData2>>): UseMutationOptions<RecordTreasuryTransferResponse, RecordTreasuryTransferError, Options<RecordTreasuryTransferData2>> => {
    const mutationOptions: UseMutationOptions<RecordTreasuryTransferResponse, RecordTreasuryTransferError, Options<RecordTreasuryTransferData2>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await recordTreasuryTransfer({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
