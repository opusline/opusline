...
export const listDeclarationsQueryKey = (options?: Options<ListDeclarationsData>) => createQueryKey('listDeclarations', options);

export const listDeclarationsOptions = (options?: Options<ListDeclarationsData>) => queryOptions<ListDeclarationsResponse, ListDeclarationsError, ListDeclarationsResponse, ReturnType<typeof listDeclarationsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: listDeclarationsQueryKey(options)
});
 ...
 */
export const recordDeclarationMutation = (options?: Partial<Options<RecordDeclarationData2>>): UseMutationOptions<RecordDeclarationResponse, RecordDeclarationError, Options<RecordDeclarationData2>> => {
    const mutationOptions: UseMutationOptions<RecordDeclarationResponse, RecordDeclarationError, Options<RecordDeclarationData2>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await recordDeclaration({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listFiscalDeadlinesQueryKey = (options?: Options<ListFiscalDeadlinesData>) => createQueryKey('listFiscalDeadlines', options);

export const listFiscalDeadlinesOptions = (options?: Options<ListFiscalDeadlinesData>) => queryOptions<ListFiscalDeadlinesResponse, ListFiscalDeadlinesError, ListFiscalDeadlinesResponse, ReturnType<typeof listFiscalDeadlinesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listFiscalDeadlines({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listFiscalDeadlinesQueryKey(options)
});
