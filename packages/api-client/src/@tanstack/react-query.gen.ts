...
export const showMissionBillingQueryKey = (options: Options<ShowMissionBillingData>) => createQueryKey('showMissionBilling', options);
 ...
 */
export const showMissionBillingOptions = (options: Options<ShowMissionBillingData>) => queryOptions<ShowMissionBillingResponse, ShowMissionBillingError, ShowMissionBillingResponse, ReturnType<typeof showMissionBillingQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await showMissionBilling({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: showMissionBillingQueryKey(options)
});

export const listMissionBillingStepsQueryKey = (options: Options<ListMissionBillingStepsData>) => createQueryKey('listMissionBillingSteps', options);

export const listMissionBillingStepsOptions = (options: Options<ListMissionBillingStepsData>) => queryOptions<ListMissionBillingStepsResponse, ListMissionBillingStepsError, ListMissionBillingStepsResponse, ReturnType<typeof listMissionBillingStepsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listMissionBillingSteps({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listMissionBillingStepsQueryKey(options)
});

export const createMissionBillingStepMutation = (options?: Partial<Options<CreateMissionBillingStepData>>): UseMutationOptions<CreateMissionBillingStepResponse, CreateMissionBillingStepError, Options<CreateMissionBillingStepData>> => {
    const mutationOptions: UseMutationOptions<CreateMissionBillingStepResponse, CreateMissionBillingStepError, Options<CreateMissionBillingStepData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createMissionBillingStep({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const markMissionBillingStepReadyMutation = (options?: Partial<Options<MarkMissionBillingStepReadyData>>): UseMutationOptions<MarkMissionBillingStepReadyResponse, MarkMissionBillingStepReadyError, Options<MarkMissionBillingStepReadyData>> => {
    const mutationOptions: UseMutationOptions<MarkMissionBillingStepReadyResponse, MarkMissionBillingStepReadyError, Options<MarkMissionBillingStepReadyData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await markMissionBillingStepReady({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const deleteMissionBillingStepMutation = (options?: Partial<Options<DeleteMissionBillingStepData>>): UseMutationOptions<DeleteMissionBillingStepResponse, DeleteMissionBillingStepError, Options<DeleteMissionBillingStepData>> => {
    const mutationOptions: UseMutationOptions<DeleteMissionBillingStepResponse, DeleteMissionBillingStepError, Options<DeleteMissionBillingStepData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteMissionBillingStep({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
