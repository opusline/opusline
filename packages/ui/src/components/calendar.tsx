import { Button, buttonVariants } from "@opusline/ui/components/button";
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        // Upstream spreads the rest of the chevron props onto the Lucide icon;
        // react-day-picker types `style` against its own csstype copy, which
        // does not line up with the one Lucide sees. Only className is needed.
        ...
        // `week` is react-day-picker's own object and must not reach the DOM.
