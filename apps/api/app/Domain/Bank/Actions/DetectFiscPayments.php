...
/**
 * Recognizes the fisc's debits in bank labels: URSSAF prélèvements and TVA
 * télérèglements. Matching is word-bounded on a normalized label — "TVA" the
 * word, never the letters inside "NUIT VALENCE" — and deliberately narrow:
 * a bare DGFiP debit is NOT treated as TVA, because the DGFiP also collects
 * income tax through the same channel.
 */
