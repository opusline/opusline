...
return [
    ...
    'paid_on_before_sent' => 'The payment date cannot precede the send date.',
    'cannot_correct_dates_unless_issued' => 'A draft has no send or payment date to correct.',
    'correction_needs_a_date' => 'Name the date to correct: when the invoice was sent, or when it was paid.',
