...
function requestDataFields(): array
{
    $responseOnly = [
        ...
        'InvoiceTodoData', 'InvoiceTodoOverdueData', 'InvoiceTodoStepData',
        'InvoiceTodoWorkData', 'InvoiceTotalData', 'MissionBillingProgressData',
        'MissionBillingStepData', 'MissionBillingStepListData', 'MissionData',
        'MissionForfaitData', 'MissionRevenueData', 'MoneyData',
        'MonthWorkloadData',
