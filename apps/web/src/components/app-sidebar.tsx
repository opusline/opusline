...
export function AppSidebar() {
  ...
  // Nothing on screen needs it until the dialog is asked for, and it reads a
  // file the backup script writes rather than anything the app keeps warm.
  const instance = useQuery({
    ...showInstanceOptions(),
    enabled: isInstanceOpen,
  });
  ...
  return (
    <>
      <InstanceDialog
        backup={instance.data?.backup ?? null}
        database={instance.data?.database ?? null}
        error={instance.isError ? m.instance_backup_failed() : null}
        isPending={instance.isPending}
        onOpenChange={setInstanceOpen}
        open={isInstanceOpen}
        version={instance.data?.version ?? null}
      />
            ...
            <SidebarMenuItem>
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem onClick={() => setInstanceOpen(true)}>
                    <Database />
